...
export default function LoginForm() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-green-50 to-blue-100 relative">
      {/* CARD */}
      <div className="bg-white rounded-xl shadow-2xl px-8 py-10 w-full max-w-sm flex flex-col items-center">
        {/* Logo */}
        <div className="flex justify-center mb-5 w-full">
          <img
            src="/logo.jpg"
            alt="Logo"
            className="w-24 h-24 rounded-full object-contain shadow-md border-4 border-green-100 bg-white"
            style={{ maxWidth: 96, maxHeight: 96 }}
          />
        </div>
        {/* Title */}
        <h1 className="text-2xl font-extrabold text-green-700 text-center mb-2">Clinical Skills Delphi</h1>
        <div className="text-sm text-gray-500 mb-6 text-center">Đăng nhập để tham gia khảo sát</div>
        {/* FORM */}
      ...
      {/* COPYRIGHT cố định dưới cùng */}
      <footer className="absolute bottom-0 left-0 w-full text-center text-xs text-gray-400 py-3">
